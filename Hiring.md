...
- Can they get stuff done? Ask them about past achievements. Previous behavior is considered the most effective indicator of how a person is going to act in the future.
- Can you work with them? Do you enjoy communicating? Does the team like the person and believe there is a cultural fit? Pay attention to the little things (do they laugh, interrupts, listen well) and this is best tested during more casual conversations.
...
Communication
- Can they explain themselves clearly? Do they follow the STAR framework? Do they talk through the thinking process? Can they break things down and explain them simply?
...
- Do they get excited by the idea of having to fulfil the role we're hiring for? And are they excited by what they've done in the past?
...
- Think through the assignment – what is this job to do in the next 90 days but also the next 24 months? As the hiring manager, write out a 90 day plan for the position you need to fill. This roadmap includes all the goals that the new team member will be expected to hit within the first ninety days of joining. This is critical for successful onboarding. During the interview process, share this roadmap with the candidate to make sure that she is excited about these goals.
 ...
 - Especially work that helps give them an understanding of data across teams and allows them to work closely with and get to know some key stakeholders 
- Create an internal JD that ties in with the development framework at the company. This is to agree on salary and framework for hiring
...
- Manager Interview
- Technical interview by manager or team member.
- Team member interview focused on cultural fit. This can also be a key stakeholder who the person is expected to work a lot with
- Director or Executive focused on strategic understanding and fit around how data can help the business, career progression, cultural fit and sanity check
...
**Scorecard**
A good scorecard process translates the objectives of the strategy into clear competencies and attributes to measure candidates against. Look for the ability to do the job that is needed today. Second we look for flexibility and adaptability for what the role may become tomorrow. Also measure against the company's values.
...
When you're near the end of the interview process, ask the candidate for 3-5 references. Ask for the list to contain people they've worked with in different relationships (a manager, a direct report, a peer, etc.), and ideally in different contexts within a company or at different companies.
...
- Other potential questions:
 ...
 - How would you rate his/her overall performance in that job on a scale of 0-10? What about his/her performance causes you to give that rating?
 - The person mentioned that he/she struggled with ________ in that job. Can you please tell me more about that?
...
*Negotitation*
"If we make you the following offer (explain every detail of the offer including benefits, etc), would you accept?”  Go back and forth until you have a verbal agreement.
If you skip this step, and simply make them the offer, then it is very common for them to ask for a few more things after-the-fact (signing bonus, moving expenses, etc). 
You will then be in the awkward position of either having to give these (and thereby allowing a political culture to begin), or starting the relationship on a negative note by saying no. 
It is far better to get the candidate to pre-agree in full detail before making the offer.  Then the relationship begins with a resoundingly positive “Yes! Thank you! I’m so excited!”
...
- Ask candidates if there is anyone else they want to talk to in the company - other teams they're interested in, folks who have been at the company a long time and might have a unique view of things, etc. Similarly, allow candidates to interview yourself for 30 minutes
...
- Notes:
 - Take notes during a interview:
   - Key take-aways
   - Notes for other interviewers: e.g. specifying areas to dig into, further evaluate, or look out for.
   - Pros and cons
...
- A stakeholder wants something done by tomorrow but your to-do list is already full - what are your next steps?
...
- Tell me about a time that you disagreed with a coworker (a manager, a peer, someone from another department, etc.). What was the situation, and what did you do to resolve the conflict?
- Describe a time you’ve had someone question your analytic work. How did you explain your process and reasoning?
...
- Explain a time when someone questioned your data.
...
General
- Can you tell more about how the team at X was organized?
 - Who was in it?
 - How do they work with stakeholders? Did they work with senior stakeholders directly as well? From gathering requirements up to presentation/delivery? Part of meetings? Catch-ups? Kick-off / requirements meetings?
...
- Tell me about the most challenging analytical project you’ve handled on your own. Things I would look for would be:
 ...
 - how did you determine it was worth time and effort?
 - How was the result measured or the solution structured? Why was it measured that way?
 - How did you communicate the end result to your stakeholders?
 - What steps or process was followed to achieve the result?
 - What tools did you use to build the solution?
 ...
 - How did it impact the business? You'd want the result to be measured ideally. Is the loop closed with happy stakeholders?
 - What did you learn from this project? Would you do anything differently in hindsight?
...
- What do you know about ecommerce and web data? Is this something of interest?
...
- Google Doc: orders, products with some null values in the data
 ...
 - Window function
 - Join with null
 - Some true/false columns with nulls - do they filter on false or null?
...
- Consider
 ...
 - Simple Google Doc in which they write queries in plain text
 
What to look for
- don’t focus on the outcome/tools but rather their communication and problem solving. Why they made certain decisions and then try to further challenge their reasoning during the interview itself.
